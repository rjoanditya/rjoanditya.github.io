        ...
        <>
            <div className="sidebar-left">
                ...
                <div className="block-popular">
                    ...
                    <div className="mt-5">
                        <SwiperDynamic className="swiper rounded-16" slidesPerView={1} spaceBetween={15} loop={true} autoplay={{ delay: 3000 }} pagination={{ clickable: true, el: ".swiper-pagination" }}>
                ...
                <div className="text-center">
                    <p className="fs-7">
                        2026 Copyright @ <span className="text-dark">Magzine.</span> <br className="d-none d-lg-block" />
